...
namespace GameServer.Network
{
    public class GameServ : Server
    {
        ...
        public override void Run()
        {
            ...
            MasterCard.Load("Data\\MasterCard.bin");
            MapMonstersList.Load("Data\\MapMonsterList.bin", MonstersEntity);
            CashShopDB.Load("Data\\CashShop.bin");
            ExtraExchange.Load("Data\\ExtraExchange.bin");
            MonstersDB.Load("Data\\Monster.bin", MonstersEntity);
            Talk.Load("Data\\Talk.bin");
            TamerList.Load("Data\\TamerList.bin");
            Reward.Load("Data\\Reward.bin");
            NPC.Load("Data\\NPC.bin");
            MapNPC.Load("Data\\MapNPC.bin");
            MapCharLight.Load("Data\\MapCharLight.bin");
        ...
        public void Command(GameClient client, string[] cmd, Digimon Activemon)
        {
            ...
            switch (cmd[0])
            {
                ...
                case "future":
                    {
                        ...
                        DigimonData data = DigimonDB.GetDigimon(71097);
                ...
                case "awaken":
                    {
                        ...
                        DigimonData data = DigimonDB.GetDigimon(75908);
                        //mon.Model = GetModel(mon.ProperModel(), mon.byteHandle);
                        mon.Model = GetModel(mon.ProperModel());
                        PacketWriter writer = new PacketWriter();
                        writer.Type(1028);
                ...
                case "tamerset":
                    {
                        ...
                        switch (cmd[1].ToLower())
                        {
                            ...
                            case "size":
                                ...
                                Packet UpdateStats = new UpdateStats(Tamer, DigimonDB.GetDigimon(Activemon.Species));
                        ...
                        Client.Send(new UpdateStats(Tamer, DigimonDB.GetDigimon(Tamer.Partner.Species)).ToArray());
                        break;
                    }
               // case "digimon.set":
                case "digimonset":
             ...
             return;
                    ...
                    {
                       DigimonData Data = DigimonDB.GetDigimon(Tamer.Partner.CurrentForm);
                       if (Data != null)
                    {
                      ...
                      //   Console.WriteLine(cmd[1].ToLower());
                        ...
                        DigimonData dData = DigimonDB.GetDigimon(Activemon.CurrentForm);
                        if (dData != null)
                        {
                            Packet UpdateStats = new UpdateStats(Tamer, DigimonDB.GetDigimon(Activemon.Species));
                ...
                case "dats":
                 ...
                 case "spawn":
                 {
                     ...
                     var digimon = DigimonDB.GetDigimon(mobId);
        ...
        public Dictionary<int, MapMonsters> Mapmonsters = new Dictionary<int, MapMonsters>();
                ...
                case 1001:
                    {
                        ...
                        if(Tamer.XAI != 0)
                        {
                            XAI xai = ItemDB.GetXAI(Tamer.XAI);
                ...
                case 1028:
                    {
                        ...
                        int evolutiontype = DigimonDB.GetEvolutionType(evolveLine.Line[1][stage]);
                        ...
                        //mon.Model = GetModel(mon.ProperModel(), mon.byteHandle);
                        mon.Model = GetModel(mon.ProperModel());
                        DigimonData data = DigimonDB.GetDigimon(evolveLine.Line[1][stage]);
                        PacketWriter writer = new PacketWriter();
                        writer.Type(1028);
                        writer.WriteInt(Tamer.DigimonHandle);
                        writer.WriteInt(Tamer.TamerHandle);
                ...
                case 1041:// DIGIMON SWITCH
                    {
                        ...
                        Packet UpdateStats = new UpdateStats(Tamer, DigimonDB.GetDigimon(target.Species));
                ...
                case 1057: //JUMP BOOSTER
                    {
                        ...
                        Region Region = RegionDB.GetID(mapid, u1);
                        if (Region != null)
                        {
                            MapData map = MapDB.GetMap(Region.MapId);
                            if (map != null)
                            {
                                _gameDatabase.SaveTamer(client);
                ...
                case 3239: //SPIRITS
                    {
                        ...
                        ExtraExchanges exchange = ExtraExchange.GetExchange(DigimonID);
                ...
                case 3971:
                    {
                        ...
                        MasterCards seal = MasterCard.Get((int)Seal.ItemId);
                        if (seal != null)
                        {
                            if (Seal.Amount > 0)
                            {
                                                ...
                                                default:
                                                    {
                                                        ...
                                                        for (int f = 0; f < container.ItemCount; f++)
                                                        {
                                                            ...
                                                            if (slotid != -1)
                                                            {
                                                                ItemData data = ItemDB.GetItem(container.Items_ItemID[f]);
                                                                if (data != null && Tamer.Inventory[slotid].Amount < data.Stack)
                                                                {
                                                                    Tamer.Inventory[slotid].Amount += newitem.Amount;
                                                                }
                ...
                case 3904: //EQUIPMENTS AND OTHERS
                    {
                        ...
                        else if (Slot1 >= 1000 && Slot1 <= 1013 && Slot2 >= 0 && Slot2 <= 150)
                        {
                            ...
                            if (Tamer.Inventory[Slot2].Amount != 0)
                            {
                                if (Slot1 == 1011)
                                {
                                    XAI xai = ItemDB.GetXAI(toEquip.ItemId);
                                    Packet XGaugeP = new XGauge(xai.XGauge, (short)xai.Unknown);
                        ...
                        else if (Slot1 >= 0 && Slot1 <= 150 && Slot2 >= 1000 && Slot2 <= 1013)
                        {
                            ...
                            if (Slot1 == 1011)
                            {
                                XAI xai = ItemDB.GetXAI(Equip.ItemId);
                                Packet XGaugeP = new XGauge(xai.XGauge, (short)xai.Unknown);
                ...
                case 3982: // ITEM MAKING
                    {
                        ...
                        ItemMaking item = ItemDB.GetID(ItemFromNPC);
                ...
                case 3987: //SCANNING
                    {
                        ...
                        Container container = ItemDB.GetContainer(UsedItem.ItemId);
                        writer.Type(3987);
                        writer.WriteInt(0);
                        writer.WriteInt(-1);
                        writer.WriteInt(-1);
